...
---
<!-- trackio-cell
{"type": "code", "id": "cell_4f0eccae7bae", "created_at": "2026-07-23T05:01:03+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_rdpg.py"], "exit_code": 0, "duration_s": 0.541}
-->
````bash
$ .venv/bin/python repro/src/verify_rdpg.py
````

exit 0 · 0.5s


````python title=verify_rdpg.py
...
==============================================================================
CLAIM 1: trailing eigenvectors delocalized, max entry bounded (Thm 3.1)
==============================================================================
  trailing max entry: 0.2550, bound r²√(log n)/√n: 0.6517
  max entry < 3×bound: True
  -> PASS

==============================================================================
CLAIM 2: over-specified (k>0) rate n^{-1/4} vs correct n^{-1/2} (Thm 3.2)
==============================================================================
  correct rate slope: -0.234 (~-0.5)
  over-spec rate slope: -0.234 (slower, closer to -0.25)
  over-spec slower: False
  -> FAIL
